...
def one_hot_categoricals(x_train, x_test, feature_names, feat_indexes, feat_types):
    ...
    categorical_features = [
        ...
        if feat_types[feature] == feature_types.FeatureType.CATEGORICAL
    ]
...
def preprocess_data():
    ...
    train_dataset, test_dataset = replace_weird_values(
        train_dataset, test_dataset, abnormal_value_replacements
    )
